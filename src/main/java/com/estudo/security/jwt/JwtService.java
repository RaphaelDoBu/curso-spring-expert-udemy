package com.estudo.security.jwt;

import com.estudo.VendasApplication;
...
public class JwtService {
    ...
    public static void main(String[] args){
        ConfigurableApplicationContext configurableApplicationContext = SpringApplication.run(VendasApplication.class);
